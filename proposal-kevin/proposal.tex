...
\begin{titlepage}
    \centering
    \vspace*{0.5in}  % Reduced vertical space at the top
    \LARGE\textbf{Data-Driven Agricultural Decision Making: A Platform for Anomaly Detection, Analytic, and Simulation}\par  % Slightly smaller font size for the title
    \vspace{0.75in}  % Adjusted spacing after the title
    \large Kevin George\par  % Reduced font size for the author
    \vspace{0.3in}  % Adjusted spacing after the author's name
    \normalsize \today  % Smaller font size for the date
    \thispagestyle{empty}
\end{titlepage}
